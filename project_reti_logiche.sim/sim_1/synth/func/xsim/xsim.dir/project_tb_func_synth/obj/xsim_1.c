...
{
	iki_relocate(dp, "xsim.dir/project_tb_func_synth/xsim.reloc",  (void **)funcTab, 110);
	iki_vhdl_file_variable_register(dp + 1209720);
	iki_vhdl_file_variable_register(dp + 1209776);
